...
function Identity({ getCurrentTabId }) {
  ...
  const setIdentityStorage = () => {
    chrome.storage.local.set({ 'voluntaryIdentity': { hispanicLatino: 'Yes', veteranStatus: 'I am not a veteran', gender: 'Male', race: 'American Indian or Alaska Native', terms: false } })
    .then(() => {
